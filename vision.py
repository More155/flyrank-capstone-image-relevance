...
# vision_model may be an alias like "gemini-flash-latest" that resolves
# differently over time). Source: ai.google.dev/gemini-api/docs/pricing,
# checked 2026-08-03. Output price already includes thinking tokens.
_PRICING_PER_TOKEN_USD: dict[str, dict[str, float]] = {
    "gemini-3.6-flash": {"input": 1.50e-6, "output": 7.50e-6},
}
_FALLBACK_PRICING_USD = {"input": 1.50e-6, "output": 7.50e-6}
